...
function Presence({ animate, apiKey, appId, channelId }) {
    ...
    return (jsxRuntime.jsxs("div", { children: [Array.from(Array(online > 4 ? 4 : online).keys()).map((p, i) => {
                return (jsxRuntime.jsxs("div", { className: "inline", children: [" ", jsxRuntime.jsx("img", { className: cx("cursor-pointer shadow-md inline w-8 border-2 -mr-3 border-blue-300 rounded-full", {
                                "hover:-translate-y-1": animate,
                            }), src: `https://source.boringavatars.com/${variants[i]}` })] }, i));
            }), online > 4 && (jsxRuntime.jsx("div", { className: "inline", children: jsxRuntime.jsxs("div", { className: cx("cursor-pointer shadow-md inline-flex items-center justify-center w-8 h-8 border-2 -mr-3 bg-blue-400 text-blue-100 text-xs border-blue-500 rounded-full", {
                        "hover:-translate-y-1": animate,
                    }), children: ["+", online - 4] }) }))] }));
}
